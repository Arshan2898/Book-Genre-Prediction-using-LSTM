...
if not os.path.exists('/Users/arshan/Desktop/projects/bookLSTM/scrapedata/test_data.csv'):
    ...
    book_data.to_csv(
        '/Users/arshan/Desktop/projects/bookLSTM/scrapedata/test_data.csv')

books = pd.read_csv(
    '/Users/arshan/Desktop/projects/bookLSTM/scrapedata/testdata.csv')
    ...
    try:
        ...
        if i % save_every == 0:
            book_data.append(pd.DataFrame.from_dict(book_rows)).to_csv(
                '/Users/arshan/Desktop/projects/bookLSTM/scrapedata/test_data.csv', index=False)
            book_rows = []
    except:
        book_data.append(pd.DataFrame.from_dict(book_rows)).to_csv(
            '/Users/arshan/Desktop/projects/bookLSTM/scrapedata/test_data.csv', index=False)
